...
final class PRFE_For_Elementor
{
    ...
    {
        require_once PRFE_PLUGIN_PATH . '/widgets/productify-product-grid.php';
    }
    ...
    public function prfe_admin_notice_missing_main_plugin()
    {
        ...
        $message = sprintf(
            esc_html__('"%1$s" requires "%2$s" to be installed and activated.', 'productify-for-elementor', 'postify-for-elementor'),
            '<strong>' . esc_html__('Productify For Elementor', 'productify-for-elementor', 'postify-for-elementor') . '</strong>',
            '<strong>' . esc_html__('Elementor', 'productify-for-elementor', 'postify-for-elementor') . '</strong>'
        );
    ...
    public function prfe_admin_notice_minimum_elementor_version()
    {
        if (isset($_GET['activate'])) unset($_GET['activate']);
        $message = sprintf(
            esc_html__('"%1$s" requires "%2$s" version %3$s or greater', 'productify-for-elementor', 'postify-for-elementor'),
            '<strong>' . esc_html__('Productify For Elementor', 'productify-for-elementor', 'postify-for-elementor') . '</strong>',
            '<strong>' . esc_html__('Elementor', 'productify-for-elementor', 'postify-for-elementor') . '</strong>',
    ...
    public function prfe_admin_notice_minimum_php_version()
    {
        ...
        $message = sprintf(
            esc_html__('"%1$s" requires "%2$s" version %3$s or greater', 'productify-for-elementor', 'postify-for-elementor'),
            '<strong>' . esc_html__('Productify For Elementor', 'productify-for-elementor', 'postify-for-elementor') . '</strong>',
            '<strong>' . esc_html__('PHP', 'productify-for-elementor', 'postify-for-elementor') . '</strong>',
